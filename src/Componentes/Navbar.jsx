...
<ul className="flex flex-col items-center gap-4 bg-[#1f1f1f] p-4 sm:flex-row sm:justify-around sm:gap-0">
          <p className='text-center text-gray-400'>Bienvenido a mi portafolio personal</p>
...
>
  <button className="bg-blue-600 hover:bg-blue-700 transition duration-300 text-amber-50 py-2 px-4 rounded-md shadow">
